...
class MY_Model extends CI_Model {
     ...
     * @return array|array[]
     */
    final public function query($limit = null, $offset = null, $key = null) {
        $table = $this->name();
        ...
        return $result->num_rows() ? $result->result_array($key) : array();
    }
     ...
     * @return array|array[]
     */
    final public function query_sql($sql, $key = null) {
        $result = $this->db()->query($sql);
        if($this->has_error()) {
            $this->reset_query();
     ...
     * @return array|array[]
     */
    final public function to_query($limit = null, $page = null, $key = null) {
        $offset = 0;
